...
class Lotus {
    ...
    constructor(apiKey, options) {
        this.getRequestObject = (method, url, data) => {
            if (!data) {
                return {
                    method: method,
    ...
    cancelSubscription(params) {
        ...
        const req = this.getRequestObject(data_types_1.REQUEST_TYPES.PATCH, data_types_1.REQUEST_URLS.CANCEL_SUBSCRIPTION(params.subscriptionId), data);
        this.setRequestTimeout(req);
        return callReq(req);
    }
    /**
    ...
    changeSubscription(params) {
        ...
        const req = this.getRequestObject(data_types_1.REQUEST_TYPES.PATCH, data_types_1.REQUEST_URLS.CHANGE_SUBSCRIPTION(params.subscriptionId), data);
        this.setRequestTimeout(req);
        return callReq(req);
    }
    /**
    ...
    getAllSubscriptions() {
        return __awaiter(this, void 0, void 0, function* () {
            const req = this.getRequestObject(data_types_1.REQUEST_TYPES.GET, data_types_1.REQUEST_URLS.GET_ALL_SUBSCRIPTIONS);
            this.setRequestTimeout(req);
            return callReq(req);
        });
    }
     ...
     *
     */
    getCustomerAccess(params) {
        return __awaiter(this, void 0, void 0, function* () {
            (0, event_validation_1.eventValidation)(params, data_types_1.ValidateEventType.customerAccess);
            const data = {
                customer_id: params.customerId,
            };
            if (params.eventName) {
            ...
            const req = this.getRequestObject(data_types_1.REQUEST_TYPES.GET, data_types_1.REQUEST_URLS.GET_CUSTOMER_ACCESS, data);
            this.setRequestTimeout(req);
            return callReq(req);
        });
    }
